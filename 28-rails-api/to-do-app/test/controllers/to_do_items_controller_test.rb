...
class ToDoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do_item" do
    assert_difference('ToDoItem.count') do
      post to_do_items_url, params: { to_do_item: { done: @to_do_item.done, title: @to_do_item.title } }
    end
  ...
  test "should update to_do_item" do
    patch to_do_item_url(@to_do_item), params: { to_do_item: { done: @to_do_item.done, title: @to_do_item.title } }
